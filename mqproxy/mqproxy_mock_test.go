...
// Source: github.com/cubefs/blobstore/mqproxy (interfaces: BlobDeleteHandler,ShardRepairHandler,Producer)
...
func (m *MockBlobDeleteHandler) SendDeleteMsg(arg0 context.Context, arg1 *mqproxy.DeleteArgs) error {
	m.ctrl.T.Helper()
...
func (m *MockShardRepairHandler) SendShardRepairMsg(arg0 context.Context, arg1 *mqproxy.ShardRepairArgs) error {
	m.ctrl.T.Helper()
