 ...
 */
func (s *Service) ShardGet_(c *rpc.Context) {
 ...
 */
func (s *Service) ShardList_(c *rpc.Context) {
 ...
 */
func (s *Service) ShardStat_(c *rpc.Context) {
 ...
 */
func (s *Service) ShardMarkdelete_(c *rpc.Context) {
 ...
 *  request body:   json.Marshal(deleteArgs)
 */
func (s *Service) ShardDelete_(c *rpc.Context) {
	args := new(bnapi.DeleteShardArgs)
	if err := c.ParseArgs(args); err != nil {
		c.RespondError(err)
		return
 ...
 */
func (s *Service) ShardPut_(c *rpc.Context) {
