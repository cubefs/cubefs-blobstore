...
type IScheduler interface {
	...
	RegisterService(ctx context.Context, args *api.RegisterServiceArgs) (err error)
	DeleteService(ctx context.Context, args *api.DeleteServiceArgs) (err error)
}
...
func NewSchedulerClient(conf *api.Config) IScheduler {
...
func (c *SchedulerClient) RegisterService(ctx context.Context, args *api.RegisterServiceArgs) error {
	pSpan := trace.SpanFromContextSafe(ctx)
	_, ctx = trace.StartSpanFromContextWithTraceID(context.Background(), "RegisterService", pSpan.TraceID())
	return c.cli.RegisterService(ctx, args)
}

// DeleteService delete service
func (c *SchedulerClient) DeleteService(ctx context.Context, args *api.DeleteServiceArgs) error {
	pSpan := trace.SpanFromContextSafe(ctx)
	_, ctx = trace.StartSpanFromContextWithTraceID(context.Background(), "DeleteService", pSpan.TraceID())
	return c.cli.DeleteService(ctx, args)
}
