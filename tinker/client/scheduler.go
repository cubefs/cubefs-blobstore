...
// IScheduler define the interface of scheduler use by tinker
type IScheduler interface {
	Register(ctx context.Context, clusterID proto.ClusterID, serviceName, host, idc string) error
	DeleteService(ctx context.Context, host string) error
