...
// IInspectCheckPointTbl define the interface of db used by inspect
type IInspectCheckPointTbl interface {
...
// InspectCheckPointTbl inspect check point table
type InspectCheckPointTbl struct {
	coll *mongo.Collection
}

// OpenInspectCheckPointTbl returns inspect check point table
func OpenInspectCheckPointTbl(coll *mongo.Collection) (IInspectCheckPointTbl, error) {
